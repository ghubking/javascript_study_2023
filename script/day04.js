//null, undefined 더이터타입 차이
//null == 변수의 값을 삭제할때 사용
//'' == 빈문자열은 dom 문자데이터를 삭제할 때 사용
let a =10
console.log(a)
...
result=number2++;
console.log(result);   //결과값: 20  현재값21
result=++number2;
console.log(result);   //결과값: 22  현재값22