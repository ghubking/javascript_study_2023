//조건문 if: 비교연산자에 의해 출력된 논리데이터의 참(true) 거짓(false)에
//따라 다른 결과값을 보여주는 조건문
//if(조건식){조건 결과가 참일 때 실행결과}  //기본문법
...
// const walkAmount = Number(window.prompt('걸음수를 입력하세요'))
// if(walkAmount >= 10000){
//     window.alert('목표달성')
// }
//-----------------------------------------------------
...
// 홀수 => '홀수입니다'
// const userInput = Number(window.prompt('숫자를 입력하세요'))
// if(userInput%2===0){
//     window.alert('짝수입니다')
// }else{
//     window.alert('홀수입니다')
...
console.log(a!==10 && a===10)  //false && true = false  --> &&연산자는 하나라도 거짓이 있으면 거짓
console.log(a!==10 || a===10) // false || true = true  --> ||연산자는 하나라도 참이 있으면 참
...
//시험점수를 입력 받고 해당 점수에 따라 A~F학점 출력하기
//100~90 A
//A가 아니라면 모두 F
const exam = 101
if(exam >= 90 && exam < 101){
